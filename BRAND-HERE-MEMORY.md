...
- The approved social-thumbnail subject is a young adult male high-fashion model in an ivory suit, with restrained Signal Red lighting; avoid a generic corporate-stock appearance.
- The approved browser icon is the Concept 3 `BH` monogram: Carbon `B`, Signal Red `H`, Digital Ivory background.
- On mobile, the homepage decision instrument uses a compact circle, places the 2×2 decision choices before the response and avoids fixed tall stages; the control, visual and response should remain understandable within one phone viewport.
- Homepage background music is optional and user-initiated through a persistent sound toggle. The approved track is `audio/music.mp3`, identical to `MAKE IT MATTER — US–UK Duet Demo B`, played at a restrained background volume. Never force autoplay.
