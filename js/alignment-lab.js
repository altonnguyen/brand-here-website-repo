...
(function () {
  ...
  if (document.documentElement.lang === 'vi') STATES = {
    ...
    drift:{name:'Trôi hướng',body:'Mọi người cùng chỉ về một phía, nhưng chưa chắc đó là nơi đáng đi. Sự đồng hướng truyền cả hướng đúng lẫn hướng sai với tốc độ như nhau.',cost:'Nguy hiểm vì các chỉ số nội bộ có thể vẫn đẹp cho đến khi thị trường chứng minh điều ngược lại.'},
